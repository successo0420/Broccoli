...
def scenario_priority_scheduling():
    ...
    queue.push(Task(task_type="priority_marker", payload={"label": "p5"}), priority=5)
    queue.push(Task(task_type="priority_marker", payload={"label": "p0"}), priority=0)
    queue.push(Task(task_type="priority_marker", payload={"label": "p2"}), priority=2)
